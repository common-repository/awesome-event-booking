...
<div class="section group">
 ...
 $aeb_settings = get_option( 'wp_event_booking-settings' ); 
	...
	<div class="participant_details">
		...
		<?php do_action('before_wpeb_checkout');?>\
        <?php
                 if($aeb_settings['recaptcha']['status']==1) {
                   ?>
                   <input type="hidden" value="" id="g-recaptcha-hd" name="g-recaptcha-hd">
               <?php } ?>
		<input type="submit" name="btn_checkout" id="btn_checkout" value="Submit"  />
