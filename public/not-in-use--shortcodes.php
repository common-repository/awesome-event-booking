...
function fnc_wpeb_my_accounts_callback() {
	$output = '<nav class="menu"><ul><li><a href="?show=future">' . __('Future Events', 'wp_event_booking') . '</a></li><li><a href="?show=past">' . __('Past Events', 'wp_event_booking') . '</a></li></nav><div class="events">';
	$_customer_id = '';
